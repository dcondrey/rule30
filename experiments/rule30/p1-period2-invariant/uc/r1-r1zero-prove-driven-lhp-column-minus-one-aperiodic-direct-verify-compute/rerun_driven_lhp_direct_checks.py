...
def main():
    ...
    with open('/Volumes/A/researchpapers/13-rule30/experiments/rule30/p1-period2-invariant/uc/r1-r1zero-prove-driven-lhp-column-minus-one-aperiodic-direct-verify-compute/rerun_driven_lhp_direct_checks.log', 'w') as f:
        f.write("\n".join(OUT) + "\n")
