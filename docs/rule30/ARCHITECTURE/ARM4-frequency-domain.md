...
intermediate rows means composing transitions, giving a degree upper bound
`2^n`, not equality. **Correction (2026-09-13):** Boolean reduction and
cancellation matter: at `n=3` the ANF degree is 5, not 8 (see section 3).
The old equality and impossibility claim are withdrawn; no algorithmic lower bound follows.
